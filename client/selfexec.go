...
//
// The form matters because a release is a Cosmopolitan APE, which a shell
// starts on any host: execve reports ENOEXEC on the APE header, and the shell
// then reads the file as the script that header is. A raw execve has no such
